...
const envSchema = z.object({
  ...
  CHAIN_SLUG: z.string().default('base'),
  SETTLEMENT_TOKEN_ADDRESS: z.string().regex(/^0x[a-fA-F0-9]{40}$/).default('0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913'),
  SETTLEMENT_TOKEN_DECIMALS: z.string().transform(Number).default('6'),
