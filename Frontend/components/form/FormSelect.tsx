...
const base =
  'w-full px-3 sm:px-4 py-2.5 bg-transparent text-white border border-gray-700/80 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-400/30 focus:border-teal-500 transition-colors cursor-pointer appearance-none pr-10 [&_option]:bg-gray-900 [&_option]:text-white [&_option]:py-2';
