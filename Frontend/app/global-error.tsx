...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      ...
      <body style={{ margin: 0, fontFamily: "'DM Sans', ui-sans-serif, system-ui, sans-serif", background: '#0a0a0a', color: '#fff', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', padding: '2rem' }}>
          <h2 style={{ marginBottom: '1rem', fontFamily: "'Sora', ui-sans-serif, system-ui, sans-serif" }}>Something went wrong</h2>
          <button
            onClick={() => reset()}
