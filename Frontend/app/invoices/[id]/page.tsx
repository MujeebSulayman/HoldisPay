...
/** Public shareable invoice view – no auth required. */
export default function PublicInvoicePage() {
  ...
  const fromLabel = invoice.business_name || 'Business';
  const logoLetter = (invoice.business_name || 'I').trim()[0]?.toUpperCase() || 'I';
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 py-[10px] overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 gap-6 px-4 py-5 border-t border-gray-100 sm:grid-cols-2 sm:gap-8 sm:px-5 sm:py-6 md:px-8">
            <div className="min-w-0">
              ...
              <p className="font-medium text-gray-900 break-words">{fromLabel}</p>
