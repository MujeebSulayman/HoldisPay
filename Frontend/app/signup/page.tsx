        ...
        <div className="w-full max-w-lg relative z-10">
          ...
          <div className="mb-12 animate-fade-in">
              ...
              <div className="w-11 h-11 bg-teal-500 rounded-lg flex items-center justify-center shadow-lg shadow-teal-500/20 transition-transform">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M9 11.5L11 13.5L15 9M20.618 5.984A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"
                  />
                </svg>
              </div>
            ...
            <div className="flex border-b border-white/10 mb-10">
              <Link
                href="/signin"
                className="pb-3 px-1 mr-8 text-sm font-medium text-gray-400 hover:text-white transition-colors duration-200"
              >
                Sign In
              </Link>
              <span className="pb-3 px-1 text-sm font-semibold text-white border-b-2 border-teal-500 -mb-px cursor-default">
                Create Account
              </span>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3.5 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-teal-500 focus:border-transparent focus:bg-white/10 transition-all duration-200 outline-none pr-12"
